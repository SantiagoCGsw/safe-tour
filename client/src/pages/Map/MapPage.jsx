...
export default function MapPage() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100vh', background: '#020b18' }}>
      <Navbar filtro={filtro} setFiltro={setFiltro} tipos={tipos} totalReportes={reportesFiltrados.length} />
      ...
      <div style={{ flex: 1, position: 'relative' }}>
        ...
        <button
          ...
          onClick={() => { setCreandoReporte(!creandoReporte); setMostrarFormulario(false); setPosicionNueva(null) }}
        >
          📋
        </button>
      </div>
